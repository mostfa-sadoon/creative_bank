...
<!-- Bread crumb and right sidebar toggle -->
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">{{trans('admin.category_add')}}</a></li>
 ...
 <form action="{{route('NewCategory.store')}}" method="post">
      @csrf
     <div class="form-group">
     <label for="exampleInputEmail1">{{trans('admin.NewCategory_in_arabic')}}</label>
     ...
     <div class="form-group">
     <label for="exampleInputEmail1">{{trans('admin.NewCategory_in_english')}}</label>
